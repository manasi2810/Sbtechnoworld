          ...
          <ul class="sidebar-menu"> 
            <li class="dropdown active">
              ...
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="">Operation Dashboard</a></li>
                <li class=active><a class="nav-link" href="">HR Dashboard</a></li>
              </ul>
            </li> 
            <li class="dropdown">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="components-article.html">Category</a></li>                 
                <li><a class="nav-link" href="components-hero.html">Product</a></li>   
                </ul>
            </li>
            <li class="dropdown">
              <a href="#" class="nav-link has-dropdown"><i class="far fa-file-alt"></i> <span>Stock Management</span></a>
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="forms-advanced-form.html"> Stock</a></li>
                <li><a class="nav-link" href="forms-editor.html">Delivery challan</a></li> 
              </ul>
            </li> 
          </ul> 
        </aside>
    ...
    <!-- Main Content -->
      ...
      <footer class="main-footer">
        <div class="footer-left">
          Copyright &copy; 2024 <div class="bullet"></div></a>
        </div>
